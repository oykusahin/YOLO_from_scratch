...
wdir = '/content/gdrive/My Drive/YOLOv3/yolov3/weights/'   #weights dir
last = '/content/gdrive/My Drive/YOLOv3/yolov3/weights/' + 'last.pt'
best = '/content/gdrive/My Drive/YOLOv3/yolov3/weights/' + 'best.pt'
results_file = '/content/gdrive/My Drive/YOLOv3/yolov3/'+ 'results.txt'
...
hyp = {'giou': 3.54,  # giou loss gain
       ...
       'obj': 10.3,  # obj loss gain (*=img_size/320 if img_size != 320)
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if save:
            ...
            if (epoch > 0) and (epoch % 10 == 0):
                torch.save(chkpt, '/content/gdrive/My Drive/YOLOv3/yolov3/weights/' + 'backup%g.pt' % epoch)
